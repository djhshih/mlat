...
struct gfOutput *gfOutputAny(char *format, int goodPpt, boolean qIsProt,
                             boolean tIsProt, boolean noHead,
                             char *databaseName, int databaseSeqCount,
                             double databaseLetters, double minIdentity,
                             FILE *f);
...
struct gfOutput *
gfOutputBlast(int goodPpt, boolean qIsProt, boolean tIsProt, char *databaseName,
 ...
 *      maskUpper - Mask out upper case sequence (currently only for
 * nucleotides).
...
void gfAlignStrand(int *pConn, char *nibDir, struct dnaSeq *seq, boolean isRc,
...
void gfAlignTrans(int *pConn, char *nibDir, aaSeq *seq, int minMatch,
                  struct hash *tFileHash, struct gfOutput *out);
