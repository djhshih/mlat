...
static char *_cgiDir() { return "../cgi-bin/"; }

static char *_trashDir() { return __trashDir; }

static double _speed() { return 1.25; }

struct webServerSpecific wssMicrosoftPWS = {
    "Microsoft-PWS", _makeTempName, _cgiDir, _speed, _trashDir,
};
